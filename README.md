...
```
python -m torch.distributed.launch --nproc_per_node=8 --use_env main.py --masks --epochs 25 --lr_drop 15 --coco_path /path/to/coco  --coco_panoptic_path /path/to/coco_panoptic  --dataset_file coco_panoptic --weights /output/path/box_model/checkpoint.pth --freeze_detr --output_dir /output/path/segm_model
```
